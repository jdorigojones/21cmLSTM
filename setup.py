...
emulator_files_list = [MODELS_INSTALL_PATH+'emulator_21cmGEM.h5', MODELS_INSTALL_PATH+'emulator_ARES.h5', MODELS_INSTALL_PATH+'train_maxs_21cmGEM.txt',\
                       MODELS_INSTALL_PATH+'train_mins_21cmGEM.txt', MODELS_INSTALL_PATH+'train_maxs_ARES.txt', MODELS_INSTALL_PATH+'train_mins_ARES.txt']

if not os.path.exists(BASE_PATH+'models/'):
   os.makedirs(BASE_PATH+'models/')

for item in emulator_files_list:
    shutil.copy(item[0], BASE_PATH+'models/emulator_21cmGEM.h5')
    shutil.copy(item[1], BASE_PATH+'models/emulator_ARES.h5')
    shutil.copy(item[2], BASE_PATH+'models/train_maxs_21cmGEM.txt')
    shutil.copy(item[3], BASE_PATH+'models/train_mins_21cmGEM.txt')
    shutil.copy(item[4], BASE_PATH+'models/train_maxs_ARES.txt')
    shutil.copy(item[5], BASE_PATH+'models/train_mins_ARES.txt')
