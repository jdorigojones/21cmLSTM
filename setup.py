...
for item in emulator_files_list:
    shutil.copyfile(MODELS_INSTALL_PATH+item[0], BASE_PATH+'models/'+item[0])
    shutil.copyfile(MODELS_INSTALL_PATH+item[1], BASE_PATH+'models/'+item[1])
    shutil.copyfile(MODELS_INSTALL_PATH+item[2], BASE_PATH+'models/'+item[2])
    shutil.copyfile(MODELS_INSTALL_PATH+item[3], BASE_PATH+'models/'+item[3])
    shutil.copyfile(MODELS_INSTALL_PATH+item[4], BASE_PATH+'models/'+item[4])
    shutil.copyfile(MODELS_INSTALL_PATH+item[5], BASE_PATH+'models/'+item[5])
