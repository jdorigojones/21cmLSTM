...
for item in emulator_files_list:
    shutil.copy(item[0], BASE_PATH+'models/')
    shutil.copy(item[1], BASE_PATH+'models/')
    shutil.copy(item[2], BASE_PATH+'models/')
    shutil.copy(item[3], BASE_PATH+'models/')
    shutil.copy(item[4], BASE_PATH+'models/')
    shutil.copy(item[5], BASE_PATH+'models/')
