...
class evaluate_foreground():
    def __init__(self, **kwargs):
        ...
        # Default model path
        default_model_path = f"/projects/jodo2960/beam_weighted_foreground/models/emulator_foreground_beam_meansub_21cmLSTM_3layer.h5" #emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer
    ...
    def __call__(self, parameters):
        ...
        nu_list = np.linspace(6,50,176)#np.linspace(5,25,80) np.linspace(5,50,180)
        vr = 1420.405751
        z_list = (vr/nu_list) - 1
