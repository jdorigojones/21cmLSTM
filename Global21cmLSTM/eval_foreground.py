...
class evaluate_foreground():
    def __init__(self, **kwargs):
        ...
        # Default model path
        default_model_path = f"/projects/jodo2960/beam_weighted_foreground/models/emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer.h5" #emulator_foreground_beam_meansub_21cmLSTM_3layer.h5
