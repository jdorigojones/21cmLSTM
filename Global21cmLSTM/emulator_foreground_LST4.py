...
with h5py.File(PATH + 'BWFG_TS_490k_10LSTs_full_variation_4regions_no_curvature_split_meansub_full_LST4.h5', "r") as f:
    print("Keys: %s" % f.keys())
...
PATH = '/projects/jodo2960/beam_weighted_foreground/'
model_save_path = PATH+"models/emulator_foreground_beam_4regions_spectralindex_meansub_full_LST4_21cmLSTM_3layer.h5"
train_mins_foreground_beam = np.load(PATH+"models/train_mins_foreground_beam_meansub_4regions_spectralindex_full_LST4.npy")
train_maxs_foreground_beam = np.load(PATH+"models/train_maxs_foreground_beam_meansub_4regions_spectralindex_full_LST4.npy")
...
class Emulate:
    def __init__(
        ...
        self.emulator = model(self.spectrum_train.shape[-1], self.par_train.shape[-1]+1, 1,
                              activation_func, name="emulator_foreground_beam_4regions_spectralindex_meansub_full_LST4_21cmLSTM_3layer") #emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer # emulator_foreground_beam_meansub_21cmLSTM_3layer
    ...
    def load_model(self, model_path=PATH+"models/emulator_foreground_beam_4regions_spectralindex_meansub_full_LST4_21cmLSTM_3layer.h5"): #emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer #emulator_foreground_beam_meansub_21cmLSTM_3layer
        """
    ...
    def train(self, epochs, batch_size, callbacks=[], verbose=2, shuffle='True'):
        ...
        self.emulator.save(PATH+'models/emulator_foreground_beam_4regions_spectralindex_meansub_full_LST4_21cmLSTM_3layer.h5') # save the entire model in HDF5 format; emulator_foreground_beam_meansub_21cmLSTM_3layer; emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer
