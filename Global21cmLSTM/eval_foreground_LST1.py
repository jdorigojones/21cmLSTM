...
class evaluate_foreground1():
    def __init__(self, **kwargs):
        ...
        if self.model is None:
            ...
            dummy_params = np.zeros((1, 11)) #np.zeros((1, 33)) np.zeros((1, 18))
            _ = self(dummy_params)
    ...
    def __call__(self, parameters):
        ...
        for i in range(N_proc):
            for j in range(n):
                proc_params_format[i, j, 0:11] = parameters[i,:]
                proc_params_format[i, j, 11] = nu_list_norm[j]
...
class evaluate_foreground2():
    def __init__(self, **kwargs):
        ...
        # Default model path
        default_model_path = f"/projects/jodo2960/beam_weighted_foreground/models/emulator_foreground_beam_4regions_spectralindex_meansub_full_LST2_21cmLSTM_3layer.h5" #emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer #emulator_foreground_beam_meansub_21cmLSTM_3layer
        model_path = kwargs.pop('model_path', default_model_path)

        # Load normalization data from the same directory as the model
        model_dir = os.path.dirname(model_path) + '/'
        self.train_mins = np.load(model_dir + 'train_mins_foreground_beam_meansub_4regions_spectralindex_full_LST2_LSTM.npy') #train_mins_foreground_beam_meansub_10regions_LSTM.npy #train_mins_foreground_beam_meansub_LSTM
        self.train_maxs = np.load(model_dir + 'train_maxs_foreground_beam_meansub_4regions_spectralindex_full_LST2_LSTM.npy')
        #self.train_mins[-2]=5/25
...
class evaluate_foreground4():
    def __init__(self, **kwargs):
        ...
        # Default model path
        default_model_path = f"/projects/jodo2960/beam_weighted_foreground/models/emulator_foreground_beam_4regions_spectralindex_meansub_full_LST4_21cmLSTM_3layer.h5" #emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer #emulator_foreground_beam_meansub_21cmLSTM_3layer
        model_path = kwargs.pop('model_path', default_model_path)

        # Load normalization data from the same directory as the model
        model_dir = os.path.dirname(model_path) + '/'
        self.train_mins = np.load(model_dir + 'train_mins_foreground_beam_meansub_4regions_spectralindex_full_LST4_LSTM.npy') #train_mins_foreground_beam_meansub_10regions_LSTM.npy #train_mins_foreground_beam_meansub_LSTM
        self.train_maxs = np.load(model_dir + 'train_maxs_foreground_beam_meansub_4regions_spectralindex_full_LST4_LSTM.npy')
        #self.train_mins[-2]=5/25
...
class evaluate_foreground5():
    def __init__(self, **kwargs):
        ...
        # Default model path
        default_model_path = f"/projects/jodo2960/beam_weighted_foreground/models/emulator_foreground_beam_4regions_spectralindex_meansub_full_LST5_21cmLSTM_3layer.h5" #emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer #emulator_foreground_beam_meansub_21cmLSTM_3layer
        model_path = kwargs.pop('model_path', default_model_path)

        # Load normalization data from the same directory as the model
        model_dir = os.path.dirname(model_path) + '/'
        self.train_mins = np.load(model_dir + 'train_mins_foreground_beam_meansub_4regions_spectralindex_full_LST5_LSTM.npy') #train_mins_foreground_beam_meansub_10regions_LSTM.npy #train_mins_foreground_beam_meansub_LSTM
        self.train_maxs = np.load(model_dir + 'train_maxs_foreground_beam_meansub_4regions_spectralindex_full_LST5_LSTM.npy')
        #self.train_mins[-2]=5/25
