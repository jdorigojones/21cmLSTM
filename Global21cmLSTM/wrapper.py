...
model_save_path_foreground = PATH+"models/emulator_foreground_beam_4regions_spectralindex_meansub_21cmLSTM_3layer.h5" #emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer #emulator_foreground_beam_meansub_21cmLSTM_3layer
		...
		'''
  		parameters: np.ndarray
	 		...
	 		The path to the saved 21cmLSTM model instance
    			Default: '/projects/jodo2960/beam_weighted_foreground/models/emulator_foreground_beam_4regions_spectralindex_meansub_21cmLSTM_3layer.h5'
       		'''
