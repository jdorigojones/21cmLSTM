...
with h5py.File(BASE_PATH_MODELS + 'dataset_ARES.h5', "r") as f:
    print("Keys: %s" % f.keys())
...
class Emulate:
    ...
    def load_model(self, model_path=BASE_PATH_MODELS+"models/emulator_ARES.h5"):
        """
        Load a saved model instance of 21cmLSTM trained on the ARES data set.
        The instance of 21cmLSTM trained on ARES included in this repository is...
    ...
    def train(self, epochs, batch_size, callbacks=[], verbose=2, shuffle='True'):
        ...
        self.emulator.save('models/emulator_ARES.h5') # save the entire model in HDF5 format
