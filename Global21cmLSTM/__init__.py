...
if not Path(PATH + "dataset_21cmGEM.h5").exists():
    ...
    with open(PATH + "dataset_21cmGEM.h5", "wb") as f1:
        f1.write(r1.content)

if not Path(PATH + "dataset_ARES.h5").exists():
    ...
    with open(PATH + "dataset_ARES.h5", "wb") as f2:
        f2.write(r2.content)
