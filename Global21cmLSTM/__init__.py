...
if not Path(BASE_PATH + "models/").exists():
    print("Transferring models/ folder containing trained instances of 21cmLSTM and preprocessing files to auxiliary folder.")
    r3 = PACKAGE_PATH + "models/"
    with open(BASE_PATH + "models/", "wb") as f3:
        f3.write(r3.content)
