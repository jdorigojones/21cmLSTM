...
if not Path(BASE_PATH + "models/emulator_21cmGEM.h5").exists():
    ...
    r3 = PACKAGE_PATH + "models/emulator_21cmGEM.h5"
...
if not Path(BASE_PATH + "models/emulator_ARES.h5").exists():
    ...
    r4 = PACKAGE_PATH + "models/emulator_ARES.h5"
