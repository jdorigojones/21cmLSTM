...
class Emulate:
    def __init__(
        ...
        self.emulator = model(self.spectrum_train.shape[-1], self.par_train.shape[-1]+1, 1,
                              activation_func, name="emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer") #emulator_foreground_beam_meansub_21cmLSTM_3layer
    ...
    def load_model(self, model_path=PATH+"models/emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer.h5"): #emulator_foreground_beam_meansub_21cmLSTM_3layer
        """
    ...
    def train(self, epochs, batch_size, callbacks=[], verbose=2, shuffle='True'):
        ...
        self.emulator.save(PATH+'models/emulator_foreground_beam_10regions_meansub_21cmLSTM_3layer.h5') # save the entire model in HDF5 format; emulator_foreground_beam_meansub_21cmLSTM_3layer.h5
