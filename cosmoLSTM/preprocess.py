...
def preproc_params(unproc_params: np.ndarray, train_params: np.ndarray) -> np.ndarray:
    ...
    np.savetxt('models/train_mins.txt', train_data_mins)
    np.savetxt('models/train_maxs.txt', train_data_maxs)
    return proc_params
...
def preproc_signals(unproc_signals: np.ndarray, train_signals: np.ndarray) -> np.ndarray:
    ...
    with open("models/train_mins.txt", "a") as f:
        f.write(str(train_signals_min))
    with open("models/train_maxs.txt", "a") as file:
